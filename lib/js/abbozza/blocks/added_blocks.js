...
Blockly.Blocks['conditional_while'] = {
  ...
  execute: function(context,envir){
    var block = this.getInputTargetBlock("loop");
     while(this.getInputTargetBlock("condition").execute(context,envir)){
        while(block){
            envir.setReady(0);
...
Blockly.Blocks['cond_if'] = {
  ...
  execute: function(context,envir){
      var cond = this.getInputTargetBlock("condition");
      if(cond.execute(context,envir)==true){
...
Blockly.Blocks['repeat'] = {
  ...
  execute :function(context,envir){
      ...
      var times = this.getInputTargetBlock("times");
