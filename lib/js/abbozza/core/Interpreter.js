...
HeapEntry.prototype.setSymbols = function(sym){
    this.symbols_ = sym;
}
/**
...
Interpreter.prototype.start = function( context, workspace, firstBlock, element ) {
    ...
    this.enqueueBlock(firstBlock,null,this.symbols);
}
...
Interpreter.prototype.getDB = function(){
    return this.symbols;
}
Interpreter.prototype.setDB = function(sym){
    this.symbols = sym;
}